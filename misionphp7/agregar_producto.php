    ...
    <div class="contenedor">
        <div class= "encabezado">
            <div class="izq">
                ...
                <p>Bienvenido/a:<br><!-- Agregar variable de sesión con nombre y apellido del usuario --><?php echo "$nombre $apellido"; ?></p>
            ...
            <div class="formulario">
                <form name="registro" method="post" action="agregar_producto.php" enctype="application/x-www-form-urlencoded">
                    ...
                    if (mysqli_fetch_array($comprobar_existencia)!=null ) {
                        echo "Ya existe un producto con este código, intentelo nuevamente";
                    }else {
